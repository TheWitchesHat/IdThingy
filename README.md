chrome.storage.sync.get("uniqueId", data => { const deviceId = data.uniqueId || crypto.randomUUID(); console.log("Device ID: ", deviceId); chrome.storage.sync.set({ uniqueId: deviceId }, () => {});
